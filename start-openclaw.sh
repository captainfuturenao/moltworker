...
# ============================================================
echo "Running holistic configuration generator (v55)..."
if [ -f "/root/clawd/configure_v2.js" ]; then
    node /root/clawd/configure_v2.js
else
    echo "CRITICAL: configure_v2.js not found! Startup aborted."
    exit 1
fi
