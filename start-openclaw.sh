...
# ============================================================
echo "Running holistic configuration generator (v56)..."
if [ -f "/root/clawd/configure_v3.js" ]; then
    node /root/clawd/configure_v3.js
else
    echo "CRITICAL: configure_v3.js not found! Startup aborted."
    exit 1
fi
